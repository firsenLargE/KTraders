...
public interface PurchaseRepository extends JpaRepository<Purchase, Long> {
    ...
    java.math.BigDecimal getTotalPurchaseAmountByDateRange(@Param("startDate") LocalDate startDate,
    ...
    @Query("SELECT p.unitCost FROM Purchase p WHERE p.product.id = :productId ORDER BY p.purchaseDate DESC, p.id DESC")
    List<java.math.BigDecimal> findUnitCostByProductId(@Param("productId") Integer productId);
}
